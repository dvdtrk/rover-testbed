...
sudo openocd -f ~/rover-testbed/firmware/pico/raspberrypi5-swd-left.cfg -f target/rp2040.cfg \
...
sudo openocd -f ~/rover-testbed/firmware/pico/raspberrypi5-swd-right.cfg -f target/rp2040.cfg \
